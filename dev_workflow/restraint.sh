...
RUN yum -y install make glib2 glib2-devel glibc-devel libarchive-devel libsoup-devel gcc pkgconfig gettext libselinux-devel openssl-devel selinux-policy-devel zlib-devel git git-daemon thttpd
