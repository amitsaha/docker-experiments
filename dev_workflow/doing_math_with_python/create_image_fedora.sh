...
FROM fedora:$1
RUN yum -y install python3-pip gcc gcc-c++ @base-x openssh-server python3-matplotlib python3-matplotlib-tk python3-sympy python3-scipy python3-numpy python3-mock python3-nose
