...
[beaker-server]
name=Beaker Server - CentOS7
baseurl=https://beaker-project.org/nightlies/develop/RedHatEnterpriseLinux7/
enabled=1
gpgcheck=0
...
name=Beaker Server - others - CentOS7
baseurl=https://beaker-project.org/yum/server-testing/RedHatEnterpriseLinux7/
enabled=1
gpgcheck=0
